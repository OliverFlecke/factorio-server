...
envsubst '${SERVER_NAME},${SERVER_DESCRIPTION},${MAX_PLAYERS},${USERNAME},${PASSWORD},${TOKEN},${SERVER_PASSWORD}' < /factorio/settings/server-settings.json > /factorio/server-settings.json
